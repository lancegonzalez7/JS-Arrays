...
function divider(numbersArray) {
    ...
    for (var i = 0; i < numbersArray.length; i++) {
        if (numbersArray[i] % 2 === 0) {
            newNumbersArray[0].push(numbersArray[i]);
        } else {
            newNumbersArray[1].push(numbersArray[i]);
        }
    }
...
function finder(numbers) {
    var numToTest = getRandomArbitrary();
    if (numbers.indexOf(numToTest) !== -1) {
        return true;
    } else {
        return false;
    }
...
//Code Here
//function removeDevEmployee(devMountainEmployees, employeeToRemove) {
...
var user3 = {
    name: 'Katelyn Gonzalez',
    email: 'katelynrosegonzalez@gmail.com',
    password: 'dfaskldjf',
    username: 'katie_rose2'
};
var user4 = {
    name: 'Leroy Jenkins',
    email: 'letsdothis@gmail.com',
    password: 'leeeroyjenkinsssssss',
    username: 'letsdothis'
};
